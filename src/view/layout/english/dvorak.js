...
const dvorak =
    <div className={'Keyboard'} key="english-dvorak">
      ...
      <div className={'Keyboard-Row'}>
        ...
        <KeyUI setKey={keysets.english.qwerty.F}/>
      ...
      <div className={'Keyboard-Row'}>
        ...
        <KeyUI setKey={keysets.english.qwerty.U} className={'underline-mark'}/>
        <KeyUI setKey={keysets.english.qwerty.I}/>
        <KeyUI setKey={keysets.english.qwerty.D}/>
        <KeyUI setKey={keysets.english.qwerty.H} className={'underline-mark'}/>
      ...
      <div className={'Keyboard-Row'}>
        ...
        <KeyUI setKey={keysets.english.qwerty.J}/>

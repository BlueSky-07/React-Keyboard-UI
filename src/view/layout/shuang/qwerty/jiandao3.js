...
const jiandao3 =
    <div className={['Keyboard', 'shuang'].join(' ')} key="shuang-jiandao3">
      ...
      <div className={'Keyboard-Row'}>
        ...
        <KeyUI setKey={keysets.shuang.jiandao3.U} className={'shuang'}/>
      ...
      <div className={'Keyboard-Row'}>
        ...
        <KeyUI setKey={keysets.shuang.jiandao3.F} className={'underline-mark shuang'}/>
        <KeyUI setKey={keysets.shuang.jiandao3.G} className={'shuang'}/>
        <KeyUI setKey={keysets.shuang.jiandao3.H} className={'shuang'}/>
        <KeyUI setKey={keysets.shuang.jiandao3.J} className={'underline-mark shuang'}/>

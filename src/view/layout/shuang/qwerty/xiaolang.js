...
const xiaolang =
    <div className={['Keyboard', 'shuang'].join(' ')} key="shuang-xiaolang">
      ...
      <div className={'Keyboard-Row'}>
        ...
        <KeyUI setKey={keysets.shuang.xiaolang.U} className={'shuang'}/>
      ...
      <div className={'Keyboard-Row'}>
        ...
        <KeyUI setKey={keysets.shuang.xiaolang.F} className={'underline-mark shuang'}/>
        <KeyUI setKey={keysets.shuang.xiaolang.G} className={'shuang'}/>
        <KeyUI setKey={keysets.shuang.xiaolang.H} className={'shuang'}/>
        <KeyUI setKey={keysets.shuang.xiaolang.J} className={'underline-mark shuang'}/>

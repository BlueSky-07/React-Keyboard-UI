...
const daniu =
    <div className={['Keyboard', 'shuang'].join(' ')} key="shuang-daniu">
      ...
      <div className={'Keyboard-Row'}>
        ...
        <KeyUI setKey={keysets.shuang.daniu.U} className={'shuang'}/>
      ...
      <div className={'Keyboard-Row'}>
        ...
        <KeyUI setKey={keysets.shuang.daniu.F} className={'underline-mark shuang'}/>
        <KeyUI setKey={keysets.shuang.daniu.G} className={'shuang'}/>
        <KeyUI setKey={keysets.shuang.daniu.H} className={'shuang'}/>
        <KeyUI setKey={keysets.shuang.daniu.J} className={'underline-mark shuang'}/>

...
const xiaoguan =
    <div className={['Keyboard', 'shuang'].join(' ')} key="shuang-xiaoguan-dvorak">
      ...
      <div className={'Keyboard-Row'}>
        ...
        <KeyUI setKey={keysets.shuang.xiaoguan.F} className={'shuang'}/>
      ...
      <div className={'Keyboard-Row'}>
        ...
        <KeyUI setKey={keysets.shuang.xiaoguan.U} className={'underline-mark shuang'}/>
        <KeyUI setKey={keysets.shuang.xiaoguan.I} className={'shuang'}/>
        <KeyUI setKey={keysets.shuang.xiaoguan.D} className={'shuang'}/>
        <KeyUI setKey={keysets.shuang.xiaoguan.H} className={'underline-mark shuang'}/>
      ...
      <div className={'Keyboard-Row'}>
        ...
        <KeyUI setKey={keysets.shuang.xiaoguan.J} className={'shuang'}/>

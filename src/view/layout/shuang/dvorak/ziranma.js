...
const ziranma =
    <div className={['Keyboard', 'shuang'].join(' ')} key="shuang-ziranma-dvorak">
      ...
      <div className={'Keyboard-Row'}>
        ...
        <KeyUI setKey={keysets.shuang.ziranma.F} className={'shuang'}/>
      ...
      <div className={'Keyboard-Row'}>
        ...
        <KeyUI setKey={keysets.shuang.ziranma.U} className={'underline-mark shuang'}/>
        <KeyUI setKey={keysets.shuang.ziranma.I} className={'shuang'}/>
        <KeyUI setKey={keysets.shuang.ziranma.D} className={'shuang'}/>
        <KeyUI setKey={keysets.shuang.ziranma.H} className={'underline-mark shuang'}/>
      ...
      <div className={'Keyboard-Row'}>
        ...
        <KeyUI setKey={keysets.shuang.ziranma.J} className={'shuang'}/>

...
const sougou =
    <div className={['Keyboard', 'shuang'].join(' ')} key="shuang-sougou-dvorak">
      ...
      <div className={'Keyboard-Row'}>
        ...
        <KeyUI setKey={keysets.shuang.sougou.F} className={'shuang'}/>
      ...
      <div className={'Keyboard-Row'}>
        ...
        <KeyUI setKey={keysets.shuang.sougou.U} className={'underline-mark shuang'}/>
        <KeyUI setKey={keysets.shuang.sougou.I} className={'shuang'}/>
        <KeyUI setKey={keysets.shuang.sougou.D} className={'shuang'}/>
        <KeyUI setKey={keysets.shuang.sougou.H} className={'underline-mark shuang'}/>
      ...
      <div className={'Keyboard-Row'}>
        ...
        <KeyUI setKey={keysets.shuang.sougou.J} className={'shuang'}/>

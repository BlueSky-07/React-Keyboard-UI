...
const pinyinjiajia =
    <div className={['Keyboard', 'shuang'].join(' ')} key="shuang-pinyinjiajia-dvorak">
      ...
      <div className={'Keyboard-Row'}>
        ...
        <KeyUI setKey={keysets.shuang.pinyinjiajia.F} className={'shuang'}/>
      ...
      <div className={'Keyboard-Row'}>
        ...
        <KeyUI setKey={keysets.shuang.pinyinjiajia.U} className={'underline-mark shuang'}/>
        <KeyUI setKey={keysets.shuang.pinyinjiajia.I} className={'shuang'}/>
        <KeyUI setKey={keysets.shuang.pinyinjiajia.D} className={'shuang'}/>
        <KeyUI setKey={keysets.shuang.pinyinjiajia.H} className={'underline-mark shuang'}/>
      ...
      <div className={'Keyboard-Row'}>
        ...
        <KeyUI setKey={keysets.shuang.pinyinjiajia.J} className={'shuang'}/>
